...
public interface RoleMapper {
    ...
    void deleteAdminRelation(Integer adminId);

    void insertRoleAdminRelation(@Param("adminId") Integer adminId, @Param("assignedRoleList") List<Integer> assignedRoleList);
}